...
exports.bulkmailCreate = (req, res) => {
    subject = req.body.subject;
    message = req.body.message;
    const email = [];
    const selectQuery = 'SELECT email FROM client';
    ...
    conn.query(selectQuery, (err, results) => {
      ...
      res.send("Clients Mails Send Successfully");
      console.log('Retrieved client emails:', email);
      sendVerificationEmail(email, subject, message); // Call your email sending function here
    }
    });
  }
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%">
              ...
              <tr>
                <td align="center" bgcolor="#e9ecef">
                  ...
                  <h1 style="margin: 0; font-size: 32px; font-weight: 700; letter-spacing: -1px; line-height: 48px;">Big Rig Pro</h1>
              ...
              <tr>
                <td align="center" bgcolor="#e9ecef">
                  ...
                  <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                    ...
                    <!-- start copy -->
                    <tr>
                      <td align="left" bgcolor="#ffffff" style="padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 10px;">
